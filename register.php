...
<body>
    ...
    ?>
    <div align="left">
    <button type="button" onclick="location.href='index.php'"  class="btn btn-info">Volver</button>
    </div>
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="formRegistro" required>
        ...
        <button type="submit" name="btnRegistrar" value="Registrarse" class="btn btn-dark">Registrarse </button>
        <br>
