...
function ValidarLoginDB($my_Db_Connection, $usuario, $clave){
    ...
    try {
        $my_Select_Statement = $my_Db_Connection->prepare("SELECT login_usuario, password_usuario, nombre_usuario, email_usuario, rol_usuario 
